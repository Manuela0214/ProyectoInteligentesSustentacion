...
//            
//        }
        GUIbueno ventana = new GUIbueno();     //------------DESCOMENTAR
        ventana.setVisible(true);     //------------DESCOMENTAR
        ventana.setLocationRelativeTo(null);     //------------DESCOMENTAR
    }

    public void crearMatriz() throws HeadlessException {
        Archivo archivo = new Archivo();
        JFileChooser fc = new JFileChooser();
        int seleccion = fc.showOpenDialog(null);
        if (seleccion == JFileChooser.APPROVE_OPTION) {
            File fichero = fc.getSelectedFile();
            this.matriz = archivo.leer(fichero.toString());

            //System.out.println("Matriz leida:");
            //imprimirMatriz();
            Matriz laberinto = new Matriz(matriz);

//            menuRecorridos(laberinto, matriz);  //     ----------COMENTAR
        }
    }
    ...
    private static void menuRecorridos(Matriz laberinto, String[][] matriz) {
